...
public class Hw1 extends Frame implements ActionListener, WindowListener, KeyListener{
...
// 너비 ARM_WIDTH(50) + margin + ARM_WIDTH(50) + BODY_WIDTH(110) + margin ARM_HEIGHT(100)
	...
	public Hw1() {
		...
		initY = LEG_HEIGHT + MARGIN + BODY_HEIGHT + 80;
		x = initX;
		y = initY;
		cx = x+BODY_WIDTH/2;
		cy = y+BODY_HEIGHT/2;
	...
	public static void main(String[] args) {
		new Hw1();	// 참조 변수 담을 필요 없이 생성자만 쓰고 있음.
	}
